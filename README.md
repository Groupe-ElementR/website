...
```
cd existing_repo
git remote add origin https://gitlab.huma-num.fr/elementr/website.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.huma-num.fr/elementr/website/-/settings/integrations)

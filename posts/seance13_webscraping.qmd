...
Un projet Rstudio comportant le script utilisé pendant la séance est téléchargeable ici :

<center><a href="https://gitlab.huma-num.fr/elementr/website/-/raw/main/posts/data/webscraping_projet.zip?inline=false" class="btn btn-success" role="button" aria-disabled="true"><i class="bi bi-cloud-arrow-down"></i> scraping.zip</a></center>
